        ...
        <div className="w-full flex justify-center items-center pt-[100px] lg:pt-[105px] pb-[100px] lg:pb-[105px]">
          <div className="w-[90%] mx-auto flex flex-col lg:flex-row justify-between items-center gap-10 md:gap-16">
            <img
              ...
              height={400}
              alt="Section Image"
              className="rounded-[10px] hover:scale-105"
            />
            <div className="flex flex-col justify-center items-start gap-4 md:gap-7">
              ...
              <p className="font-inter font-semibold text-[1.5rem] md:text-[56px] md:leading-[60px] tracking-[0%] align-centre hover:scale-105">
                We Are Increasing Business Success With Technology
              </p>
              <p className="font-inter font-normal text-sm md:text-[18px] md:leading-[28px] tracking-[0%] align-center hover:scale-105">
              ...
              <>
                ...
                <div className="w-full flex justify-end items-center gap-[20px] mt-[-30px] 2xl:mr-[100px]">
                  {currentIndex > 0 && (
                    <div
                      onClick={handlePrev}
                      className={`rounded-full w-[54px] h-[54px] border ${
                        currentIndex > 0 ? "bg-[#4A2848]" : "bg-transparent"
                  ...
                  {currentIndex < ReviewsData?.data?.length - 1 && (
                    <div
                      onClick={handleNext}
                      className={`rounded-full w-[54px] h-[54px] border border-black flex justify-center items-center ${
                        currentIndex < ReviewsData?.data.length - 1
                          ? "bg-[#4A2848]"
                          : "bg-transparent"
                      } cursor-pointer`}
