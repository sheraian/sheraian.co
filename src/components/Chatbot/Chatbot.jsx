...
function Chatbot(text) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div className="w-[90%] lg:w-[420px] mx-auto bg-white  rounded-lg relative overflow-hidden ">
        ...
        <div className=" flex flex-col gap-[20px] py-[25px] px-[22px] h-[460px] overflow-y-auto mb-[4rem] scrollbar-thin">
