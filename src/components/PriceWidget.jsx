...
function PriceWidget() {
  return (
    <div className="w-full bg-[url('frame.png')]   flex flex-col items-center py-10 gap-8 md:gap-12 bg-cover bg-cyan-500">
      <p className="inline-block bg-[#D7D5DF] p-2 px-5 rounded-full font-semibold text-[16px] text-[#4A2848]">Our pricing</p>
      <span className="text-[1.5rem] md:text-[3rem] text-white font-semibold font-poppins leading-none">Our popular pricing package</span>
      <div className="w-[90%] mx-auto flex flex-col gap-10 md:gap-0 md:flex-row items-center justify-between pt-2">
