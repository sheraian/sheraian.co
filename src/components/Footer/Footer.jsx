      ...
      <div className="w-full flex flex-col justify-between items-center gap-y-[2.5rem]">
        ...
        <div className="w-[90%] flex flex-col sm:flex-row flex-wrap justify-between items-center lg:items-start gap-[2rem] md:gap-y-[6rem]">
          ...
          <div className="flex flex-col justify-center items-center gap-y-8">
            <div class="font-inter font-bold text-[22px] leading-[24px] tracking-[0] text-white text-center lg:text-start">Quick Link</div>
              ...
              {[
                ...
                return (
                  <Link to={d.link} key={index} className="flex justify-start items-center gap-3">
                    <img src="/assets/Footer/DoubleArrow.svg" alt="" className="hidden lg:flex" />
                    <p class="font-inter font-normal text-[14px] lg:text-[18px] leading-[20px] tracking-[0] text-white/80">{d.name}</p>
                  </Link>
                );
              })}
            </div>
          ...
          <div className="flex flex-col justify-center items-center lg:items-start gap-y-8">
            <div class="font-inter font-bold text-[22px] leading-[24px] tracking-[0] text-white text-center lg:text-start">Our Services</div>
            <div className="flex flex-col justify-center items-center lg:items-start gap-y-[1rem]">
              {[
                ...
                return (
                  <Link to={d.link} key={index} className="flex justify-start items-center gap-3">
                    <img src="/assets/Footer/DoubleArrow.svg" alt="" className="hidden lg:flex" />
                    <p class="font-inter font-normal text-[14px] lg:text-[18px] leading-[22px] tracking-[0] text-white/80">{d.name}</p>
                  </Link>
                );
              })}
            </div>
